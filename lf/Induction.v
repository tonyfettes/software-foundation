...
Proof.
  ...
  - simpl. reflexivity.
  - rewrite -> IHn'.
    rewrite -> negb_elim. simpl. reflexivity.
Qed.
(** [] *)
...
Lemma mul_plus_1 : forall n m : nat,
  n * (1 + m) = n + n * m.
Proof.
  intros n m.
  simpl.
...
Theorem emb : forall b : bool, orb b (negb b) = true.
Proof.
  intros b.
  destruct b.
  - simpl. reflexivity.
...
Proof.
  ...
  - simpl.
    ...
    replace (bin_to_nat b * 2 + 1) with (1 + bin_to_nat b * 2).
    reflexivity.
    + rewrite add_comm. reflexivity.
Qed.
...
Lemma mult_2_double_bin : forall n : nat, nat_to_bin (n * 2) = double_bin (nat_to_bin n).
Proof.
  intros n.
  induction n.
  - simpl. reflexivity.
...
Lemma add_1_incr_bin : forall n : nat, nat_to_bin (n + 1) = incr (nat_to_bin n).
Proof.
  intros n.
  induction n.
  - simpl. reflexivity.
...
Proof.
  ...
  induction b.
  - simpl. reflexivity.
  - simpl. rewrite <- IHb. rewrite mult_2_double_bin. reflexivity.
  - simpl. rewrite <- IHb. rewrite add_1_incr_bin. rewrite mult_2_double_bin. reflexivity.
Qed.
(** [] *)
